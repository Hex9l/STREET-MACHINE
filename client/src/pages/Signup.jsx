    ...
    return (
        <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-[#050505]">
            ...
            <div className="absolute inset-0 z-0">
                <div className="absolute top-0 left-0 w-full h-full bg-[url('https://placehold.co/1920x1080/050505/ef4444?text=Signup+Background')] bg-cover bg-center opacity-20 blur-sm brightness-50" />
            ...
            >
                <div className="text-center mb-10 transform skew-x-[1deg]">
                    <span className="text-[#ef4444] uppercase tracking-[0.3em] text-[10px] font-bold block mb-2">New Entry</span>
                ...
                <form onSubmit={handleSubmit} className="space-y-6 transform skew-x-[1deg]">
                    <div className="space-y-1">
                        <label className="text-xs uppercase tracking-widest text-[#ef4444] font-bold ml-1">Call Sign (Username)</label>
                        <input
                            type="text"
                            value={username}
                ...
                <p className="mt-10 text-center text-gray-500 text-xs uppercase tracking-widest transform skew-x-[1deg] font-bold">
                    Already Registered?{' '}
                    <Link to="/login" className="text-[#ef4444] hover:text-white transition-colors border-b border-[#ef4444] pb-0.5 ml-2">
                        System Access
                    </Link>
                </p>
            </motion.div>
